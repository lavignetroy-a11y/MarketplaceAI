...
const APPLIANCE: CategoryProfile = {
  ...
  shots: [
    ...
    { role: 'primary_interior', answers: 'What is the inside like, and is it clean?', scope: 'detail', priority: 2 },
    { role: 'control_panel', answers: 'What settings does it have and how worn are the controls?', scope: 'detail', priority: 3 },
    { role: 'secondary_interior', answers: 'What is the inside of the second unit like?', scope: 'detail', priority: 4 },
    { role: 'front_square', answers: 'What are its true proportions, and how do the units sit together?', scope: 'full_set', priority: 5 },
    { role: 'front_right_three_quarter', answers: 'What does the other front corner look like?', scope: 'full_set', priority: 6 },
    { role: 'doors_open', answers: 'What does it look like open, and does everything open properly?', scope: 'full_set', priority: 7 },
